import { View, Text, useColorScheme, TouchableOpacity, StyleSheet, TextInput, Keyboard } from 'react-native'
    ...
    <View style={className`${ currentMode === 'light' ? 'bg-[#f7f7f7]' : 'bg-[#000e28]'} px-2 py-2 h-screen flex-1`}>
      ...
      <View style={className`px-4`}>
        <View style={className``}>
          <Text style={className` ${ currentMode === 'light' ? 'text-black' : 'text-white'} font-bold text-2xl text-left pt-5 pb-1`}>Verify your BVN</Text>
          <Text style={className` ${ currentMode === 'light' ? 'text-black' : 'text-white'} text-xs text-left pb-7`}>Enter your 11 digit BVN</Text>
        </View>
