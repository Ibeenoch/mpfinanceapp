    ...
    <View style={className`flex-1 ${currentMode === 'light' ? 'bg-[#f7f7f7]' : 'bg-[#0e1a32]'}`}>
        ...
        {arrNum.map((num, index) => (
          <TextInput
            ...
            style={className`p-2 rounded-md font-bold text-lg text-center ${ currentIndex === index ? 'border border-[#0261ef]' : 'border border-[]'}  ${currentMode === 'light' ? 'text-black bg-white' : 'text-white bg-[#1a263e]'}`}
