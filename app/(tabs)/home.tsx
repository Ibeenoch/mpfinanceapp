  ...
  return (
    <ScrollView>
      <View style={className`p-4 flex-1 ${getmode.dasboardBackgroundFirstLayerColor}`}>
          ...
          <View style={className`rounded-xl ${getmode.dasboardBackgroundSecondLayerColor} `}>
            <View style={className`flex-row w-full rounded-full border border-gray-300 p-2`}>
                <View style={className`flex-row gap-1 rounded-full border border-gray-300 `}>
                ...
                <View style={className`p-1 rounded-full border border-gray-300`}>
                    <Copy width={7} height={7} fill={getmode.dasboardSvgButton} />
                </View>

            </View>

            <View style={className`py-4 px-6 flex justify-between rounded-xl ${getmode.dasboardBackgroundButtonColor}`}>
              <Text style={className`${getmode.textColorTwoInverse} font-bold text-xl`}>N0.00</Text>
