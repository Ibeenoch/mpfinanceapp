  ...
  return (
    ...
    <View style={className`p-2 flex-1 rounded-xl ${getmode.firstLayerBgColor}`}>
      <View style={className` rounded-xl`}>
          <Image source={require('../../assets/comingcampain.png')} style={className`w-full h-20 rounded-xl`} />
      </View>
      ...
      <View style={[className`p-2 rounded-full border border-gray-300`, styles.dashBorder]}>
        ...
        <View style={className`flex-row py-2 gap-2`}>
          <View style={className`flex-row justify-center items-center rounded-lg p-1 bg-[#b9c1ce]`}>
            <View style={className`flex-row justify-center items-center rounded-lg p-1 bg-[#1fb02f]`}>
              <CheckMark width={11} height={11} fill={`${getmode.fillColor}`} />
            </View>
          </View>

          <View style={className`pr-3`}>
            <Text style={className`text-sm font-semibold ${getmode.textColorTwo}`}>Get up to 100% of your earned salary</Text>
          </View>
        </View>
